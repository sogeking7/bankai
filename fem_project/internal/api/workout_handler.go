...
import (
	...
	"github.com/sogeking7/femProject/internal/middleware"
...
func (wh *WorkoutHandler) HandleUpdateWorkoutById(w http.ResponseWriter, r *http.Request) {
	...
	if updateWorkoutRequest.DurationMinutes != nil {
		existingWorkout.DurationMintues = *updateWorkoutRequest.DurationMinutes
	}
...
func (wh *WorkoutHandler) HandleDeleteWorkoutById(w http.ResponseWriter, r *http.Request) {
	...
	currentUser := middleware.GetUser(r)
	if currentUser == nil || currentUser == store.AnonymousUser {
		utils.WriteJSON(w, http.StatusUnauthorized, utils.Envelope{"error": "you must be logged in to delete"})
		return
	}
